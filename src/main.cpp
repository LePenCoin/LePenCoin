...
unsigned int nTargetSpacing = 1 * 30; // LePen - 0.5 minute blocks
...
unsigned int nModifierInterval = 10 * 60; // LePen - time to elapse before new modifier is computed
...
const string strMessageMagic = "LePen Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LePen", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "http://www.bbc.com/news/world-us-canada-38688507";
        CTransaction txNew;
        txNew.nTime = 1484948068;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1484948068;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 31774166;
        ...
        assert(block.hashMerkleRoot == uint256("0xa74bdf32e66585422a65e41b01c4af0a4b616dad3eb135b5dbed03763b0a844d"));
