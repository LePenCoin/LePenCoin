...
private slots:
    ...
    void on_BuyLePen_clicked();
    void on_SellLePenBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputLePen_textChanged(const QString &arg1);
    ...
    QString BuyLePen(QString OrderType, double Quantity, double Rate);
    QString SellLePen(QString OrderType, double Quantity, double Rate);
